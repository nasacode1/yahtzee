...
public class player {
	...
	public void calculateScore(int[] values, Scanner scanner) {
		...
		case 12: 
			...
			if(verifyCount(values, 5, n8)) {
				currScore += (flag == 1) ? 100: 50;
			}
			else {
				System.out.println("Sorry you dont qualify for a yahtzee");
			}
		case 13:
			System.out.println("This is chance. We take sum of all dices here.");
			for(int value:values) {
				currScore += value;
			}
	}
